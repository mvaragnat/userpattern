...
UserPatterns.configure do |config|
  ...
  # ─── Data retention ────────────────────────────────────────────────
  # Raw events older than this are deleted by `rake user_patterns:cleanup`.
  # config.retention_period = 30  # days

  # ─── Dashboard authentication ──────────────────────────────────────
  # The dashboard is secure by default. Set these environment variables:
  #   USER_PATTERNS_DASHBOARD_USER
  #   USER_PATTERNS_DASHBOARD_PASSWORD
  #
  ...
  #   :record  — persist to user_patterns_violations table (visible in dashboard)
